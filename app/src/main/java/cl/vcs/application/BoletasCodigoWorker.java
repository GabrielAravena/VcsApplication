...
public class BoletasCodigoWorker extends Worker {

    public BoletasCodigoWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    static void enviarDatos(Data datos, Context context) {
        ...
        WorkRequest boletasWorkerRequest =
                new OneTimeWorkRequest.Builder(BoletasCodigoWorker.class)
                        .setBackoffCriteria(
    ...
    public static int[] contarWorkers(String tag, Context context) throws ExecutionException, InterruptedException {
        ...
        WorkQuery workQueryRunning = WorkQuery.Builder
                .fromTags(Arrays.asList("boletasCodigoWorker"))
    ...
    public Result doWork() {
        ...
        String codigo = getInputData().getString("codigo");
        ...
        try {
            ...
            String url = "https://restapi.vrrd.cl/api/EntregaBoleta"; // Cambiar URL
